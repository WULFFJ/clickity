...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.recordButton.setStyleSheet('QPushButton {background-color: #7c0a02; color: rgb(238,238,238);}')

        self.stopButton = QPushButton('Stop/pause\nrecording')
        grid.addWidget(self.stopButton, 1, 0)
        self.stopButton.clicked.connect(self.stop_record)
        self.stopButton.setStyleSheet('QPushButton {background-color: #000000; color: rgb(238,238,238);}')

        self.playButton = QPushButton('Run')
        grid.addWidget(self.playButton, 2, 0)
        self.playButton.clicked.connect(self.play)
        self.playButton.setStyleSheet('QPushButton {background-color: #555759; color: rgb(238,238,238);}')
        ...
        self.playBox.setStyleSheet('QSpinBox {color : #555251; background-color : #ffffff;}')
        ...
        self.skipBox.setStyleSheet('QSpinBox {color : #555251; background-color : #ffffff;}')
        ...
        self.mouseBox.setStyleSheet('QSpinBox {color : #555251; background-color : #ffffff;}')
        ...
        self.keyBox.setStyleSheet('QSpinBox {color : #555251; background-color : #ffffff;}')
        ...
        self.emptyButton.setStyleSheet('QPushButton {background-color: #555759; color: rgb(238,238,238);}')
        ...
        self.emptyButton2.setStyleSheet('QPushButton {background-color: #555759; color: rgb(238,238,238);}')
        self.delBox = QSpinBox()
        grid.addWidget(self.delBox, 9, 1)
        self.delBox.setStyleSheet('QSpinBox {color : #555251; background-color : #ffffff;}')
        self.delBox.setMinimum(1)

        self.saveButton = QPushButton('Save')
        grid.addWidget(self.saveButton, 11, 0)
        self.saveButton.clicked.connect(self.file_save)
        self.saveButton.setStyleSheet('QPushButton {background-color: #555759; color: rgb(238,238,238);}')

        self.loadButton = QPushButton('Load')
        grid.addWidget(self.loadButton, 12, 0)
        self.loadButton.clicked.connect(self.file_load)
        self.loadButton.setStyleSheet('QPushButton {background-color: #555759; color: rgb(238,238,238);}')
        ...
        self.update_table()
        self.table.setStyleSheet('QTableWidget {background-color: #9c9999; color: rgb(238,238,238);}')
        grid.addWidget(QLabel('Select another cell after changing a wait-time '
                              'otherwise it will not be registered!'), 12, 4)


        self.setWindowTitle(self.title)
        self.setStyleSheet("background-color: #701112;")
    ...
    def update_table(self):
        ...
        for i, row in self.keyEvents.iterrows():
            for j, data in enumerate(row):
                ...
                if i < self.skipFirst:
                    color = QColor(55, 52, 12)

                item.setBackground(128, 0, 128)
